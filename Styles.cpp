...
void WindowStyle::About(int x, int y, int w, int h)
{
	...
	gInts.Surface->GetTextSize(gFonts.calibri_light, L"Exxtion", dcWidth, dcHeight);
	gDrawManager.DrawString(CenterX - (dcWidth / 2), y + 110 + iHeight, Color::Rainbow(), L"Exxtion");
}